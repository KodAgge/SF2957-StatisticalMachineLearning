    ...
    for epsilon in [0.2, 0.1, 0.05, 0.01]:
        ...
        for decks in [1,2,6,8,inf]:
            ...
            Q_MC, MC_avg_reward, state_action_count = rl.learn_MC(
                ...
                episode_file=path_fun("hand_MC_state"+suffix), warmup=warmup, decaying=True)
            ...
            print(time_to_completion_MC, 'seconds')
            ...
            Q, avg_reward, state_action_count = rl.learn_Q(
                ...
                episode_file=path_fun("hand_state"+suffix), warmup=warmup, decaying=True)
            ...
            sumQ, sum_avg_reward, sum_state_action_count = rl.learn_Q(
                ...
                episode_file=path_fun("sum_state"+suffix), warmup=warmup, decaying=True)
            ...
            pl.plot_value_function(V_conv_filt_MC,
                                ...
                                directory = plot_dir,
                                file_name = "3D_exp_MC_" + str(decks) + "_decks"+ suffix +".png")
            ...
            pl.plot_value_function(V_conv_filt,
                                ...
                                directory = plot_dir,
                                file_name = "3D_exp_" + str(decks) + "_decks" + suffix +".png")
            ...
            pl.plot_value_function(V_sum_filt,
                                ...
                                directory = plot_dir,
                                file_name = "3D_sum_" + str(decks) + "_decks" + suffix +".png")

            # create line plots
            env_types = ["hand_MC", "hand", "sum"]
            fig, lgd = pl.plot_avg_reward_episode(directory, env_types, [str(decks)], suffix)
            fig.savefig("{}/avgReturnEp_ndeck{}{}.png".format(plot_dir, decks, suffix),
